...
import android.database.sqlite.SQLiteDatabase; import android.os.Bundle; import android.view.View; import android.widget.Button; import android.widget.EditText; 
public class MainActivity extends Activity implements View.OnClickListener { 
    EditText editRollno, editName, editMarks; 
    Button btnAdd, btnDelete, btnModify, btnView, btnViewAll, btnShowInfo; 
    SQLiteDatabase db;     @Override 
    protected void onCreate(Bundle savedInstanceState) {         super.onCreate(savedInstanceState);         setContentView(R.layout.activity_main);         editRollno = (EditText) findViewById(R.id.enroll);         editName = (EditText) findViewById(R.id.name);         editMarks = (EditText) findViewById(R.id.marks);         btnAdd = (Button) findViewById(R.id.add);         btnDelete = (Button) findViewById(R.id.delete);         btnModify = (Button) findViewById(R.id.modify);         btnView = (Button) findViewById(R.id.view);         btnViewAll = (Button) findViewById(R.id.viewAll);         btnShowInfo = (Button) findViewById(R.id.show); 
         btnAdd.setOnClickListener((View.OnClickListener) this);         btnDelete.setOnClickListener((View.OnClickListener) this);         btnModify.setOnClickListener((View.OnClickListener) this);         btnView.setOnClickListener((View.OnClickListener) this);         btnViewAll.setOnClickListener((View.OnClickListener) this);         btnShowInfo.setOnClickListener((View.OnClickListener) this);         db = openOrCreateDatabase("StudentDB", Context.MODE_PRIVATE, null);         db.execSQL("CREATE TABLE IF NOT EXISTS student(rollno VARCHAR,name 
...
"');"); 
        ...
        if (view == btnDelete) { 
            ...
            Cursor c = db.rawQuery("SELECT * FROM student WHERE rollno='" +                     editRollno.getText() + "'", null);             if (c.moveToFirst()) { 
                db.execSQL("DELETE FROM student WHERE rollno='" +                         editRollno.getText() + "'");                 showMessage("Success", "Record Deleted"); 
            } else { 
        ...
        if (view == btnShowInfo) { 
            showMessage("Student Management Application", "Developed By 
Mahnoor Razzaq"); 
        }     } 
